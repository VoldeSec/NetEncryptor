# NetEncryptor
Encryptor of CSharp binary, shellcode in bin format and any strings with AES or XOR. Built for the combined usage of NetLoader to provide more obfuscation.
